...
L'application est connectable à un serveur de base de donnée MySQL.  L'affichage du catalogue des véhicules d'occasion créé se fait sur un siteweb ; un autre projet lié au cardealershiptest : [vehicletestweb](www.github.com/ghr00/vehicletestweb).
...
Cette même base de donnée est la même que celle au quel est connecté le siteweb [vehicletestweb](www.github.com/ghr00/vehicletestweb).
